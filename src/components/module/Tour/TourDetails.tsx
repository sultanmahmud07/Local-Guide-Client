...
<div className=" space-y-6 bg-white  md:p-0 rounded-t-3xl md:rounded-none shadow-sm md:shadow-none">
            ...
            <div className="grid md:grid-cols-2 gap-8">
             ...
             <div className="bg-gray-50 p-6 rounded-xl flex items-center gap-4">
                <div className="w-16 h-16 rounded-full bg-gray-200 overflow-hidden shrink-0">
                    {/* Placeholder for Author Image - Assuming standard user image or default */}
                    <Image 
                        src={"/default.png"} 
                        alt={tour?.author?.name || "author name"} 
                        width={64} 
                        height={64} 
                ...
                <div>
                    <p className="text-xs font-bold text-primary uppercase tracking-wider">Your Local Host</p>
                    <h3 className="text-xl font-bold text-gray-900">{tour?.author?.name}</h3>
                    <p className="text-sm text-gray-500">Professional Guide • {tour.language} Speaker</p>
                </div>
             </div>
